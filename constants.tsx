...
export const INITIAL_TRANSACTIONS: Transaction[] = [
  { id: 1, guestId: 1, description: 'Room Charge - 1 night', amount: 150, date: '2023-10-26' },
  { id: 2, guestId: 1, description: 'Room Service', amount: 45.50, date: '2023-10-26' },
  { id: 3, guestId: 1, description: 'Payment - Credit Card', amount: -195.50, date: '2023-10-27' },
  { id: 4, guestId: 2, description: 'Room Charge - 1 night', amount: 250, date: '2023-10-27' },
];
...
export const ROOM_STATUS_THEME: { [key in RoomStatus]: { light: string; dark: string; text: string; badge: string; } } = {
  [RoomStatus.Vacant]: { light: 'bg-green-100', dark: 'dark:bg-green-900', text: 'text-green-800 dark:text-green-200', badge: 'bg-green-500' },
  [RoomStatus.Occupied]: { light: 'bg-blue-100', dark: 'dark:bg-blue-900', text: 'text-blue-800 dark:text-blue-200', badge: 'bg-blue-500' },
  [RoomStatus.Dirty]: { light: 'bg-yellow-100', dark: 'dark:bg-yellow-900', text: 'text-yellow-800 dark:text-yellow-200', badge: 'bg-yellow-500' },
  [RoomStatus.Cleaning]: { light: 'bg-indigo-100', dark: 'dark:bg-indigo-900', text: 'text-indigo-800 dark:text-indigo-200', badge: 'bg-indigo-500' },
  [RoomStatus.OutOfOrder]: { light: 'bg-red-100', dark: 'dark:bg-red-900', text: 'text-red-800 dark:text-red-200', badge: 'bg-red-600' },
};
